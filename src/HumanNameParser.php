...
class HumanNameParser{
	 ...
	 *
	 * @param array $rename_keys
	 *
	 * @return array
	 */
	public function parse($rename_keys = []){
		...
		return array(
			$key_map['full']       => $this->getFullName(),
			$key_map['salutation'] => $this->getSalutation(),
			$key_map['first']      => $this->getFirstName(),
			$key_map['middle']     => $this->getMiddleName(),
			$key_map['last']       => $this->getLastName(),
			$key_map['suffix']     => $this->getSuffix()
		);
	}
